...
void Initial_IO(void)
{
    ...
    P1DIR |= 0xff;     //P1定义为输出
	// Master Mode
	PERCFG |= 0x02; //PERCFG.U1CFG = 1，配置功能选项
	P1SEL |= 0xE0; //1110 0000使用P1_7, P1_6, P1_5作为外设
	P1SEL &= ~0x10; //1110 1111使用P1_4作为SSN配置位GPIO输出功能
	P1DIR |= 0x10; //SSN设置为输出
	// Slave mode
	// PERCFG |= 0x02; //PERCFG.U1CFG = 1，配置功能选项
	// P1SEL |= 0xF0; //1111 0000使用P1_7, P1_6, P1_5, P1_4作为外设
	// 设置SPI时钟波特率 3.25MHz
